...
const imagesArray = [
    {
      id: 1,
      url: '../images/Accessories/Watch/watch-4.png',
      name: 'Watch-1',
    ...
    {
      id: 3,
      url: '../images/Accessories/Watch/watch-3.png',
      name: 'Watch-3',
      content: 'The Watch is made of white beads and features a pendant. The beads are arranged in a circular pattern, creating a visually appealing design. The pendant adds a touch of elegance to the overall look of the necklace.'
    },
    {
      id: 4,
      url: '../images/Accessories/Watch/watch-4.png',
      name: 'Watch-4',
      content: 'The Watch in the image is a white beaded piece with a circular pattern, featuring a beautiful pendant. The beads are likely made of glass or a similar material, and the pendant adds a touch of elegance to the overall design. The necklace is a simple yet stylish accessory that can be worn with various outfits.'
    },
    {
      id: 5,
